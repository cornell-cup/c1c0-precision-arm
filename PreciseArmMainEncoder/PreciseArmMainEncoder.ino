...
int motorIndex;
int input;
volatile bool moving[] = {false, false, false, false, false, false};

static int8_t data_angles[] = {0,0,0,0,0,0};
...
void loop()
{
  ...
  //   Serial.print(i+1);
  //   Serial.print(": ");
  //   Serial.print(encoders[i].current_angle);
  //   Serial.println("");
  //   delay(100);
  // }
  // Serial.println("");
...
void changeAngles(int8_t *data)
{
  for (int i = 1; i < 3; i++)
  {
    ...
    // Serial.println(encoders[i].target_angle);
